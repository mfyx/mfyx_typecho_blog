            ...
            <span class="comment-author vcard">
              <b class="fn"><?php echo $author; ?></b><?php echo $Identity; ?>
                    ...
                    <div class="comment-content m-t-sm">
                        <span class="comment-author-at"><b><?php get_comment_at($comments->coid)?></b></span><span class="comment-content-true">
                            <?php
                                echo Content::postCommentContent($comments->content,$GLOBALS['isLogin']);
                            ?>
                        </span>
                    </div>
                    <!--回复按钮-->
            ...
            <div id="<?php $this->respondId(); ?>" class="respond comment-respond">
                ...
                <form id="comment_form" method="post" action="<?php $this->commentUrl() ?>"  class="comment-form" role="form">
                    <div class="comment-form-comment form-group">
                        ...
                        data-original-title="<?php _me("开启该功能，您的评论仅作者可见") ?>">
