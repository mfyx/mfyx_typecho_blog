                    ...
                    <div class="">
                        ...
                        <ul class="list-group no-bg no-borders pull-in">
                            ...
                            foreach ($contactItems as $contactItem){
                                ...
                                $contactItemsOutput .= '<li class="list-group-item"><a href="'.$itemLink.'" class="pull-left thumb-sm avatar m-r"><img src="'.$itemImg.'" class="img-circle"><i class="on b-white bottom"></i></a><div class="clear"><div><a href="'.$itemLink.'">'.$itemName.'</a></div><small class="text-muted">'.$itemValue.'</small></div></li>';
                            }
                            ?>
