...
class Handsome{
	...
	public static $versionTag = "20180701901";//版本号后缀，区别同一版本不同修改日期
...
<div class="mdui-card">
  ...
  <div class="mdui-card-actions">
    <button class="mdui-btn mdui-ripple"><a href="https://handsome.ihewro.com/">使用文档</a></button>
    <button class="mdui-btn mdui-ripple"><a href="https://www.ihewro.com/archives/489/">主题介绍</a></button>
...
(function($){
    ...
    function(data){
        ...
        if(VersionCompare("$current_version", data.tag_name)){//有更新版本更新
            ...
            var message = "<span class=\"mdui-chip-icon mdui-color-red\"><i class=\"mdui-icon material-icons\">update</i></span><span class=\"mdui-chip-title\">"+updateWord+"</span>";
            var color = "#ff5252";
            ...
            mdui.JQ('#updateDialog').on('confirm.mdui.dialog', function (e) {
                mdui.alert('请查收您的更新邮件（可能在垃圾箱中），如果没有发送到请联系主题作者');
            })
            
        }else{//当前为最新版本
        
            $("#update_notification").css("color","#1abc9c").html("<span class=\"mdui-chip-icon mdui-color-green\"><i class=\"mdui-icon material-icons\">update</i></span><span class=\"mdui-chip-title\">当前是最新版本</span>");
